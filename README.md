...
- Processes each NTFSInfo file found:
  ...
  - Joins the NTFSInfo dataframe with the scanned files dataframe on VolumeID, ParentFRN, FRN, and SnapshotID.
...
### Shadow copy filenames

When a restored file comes from a shadow copy, Restore_FS prefixes the restored basename with the `SnapshotID` by default.

Example:

```text
NTUSER.DAT -> 11111111-2222-3333-4444-555555555555__NTUSER.DAT
```
